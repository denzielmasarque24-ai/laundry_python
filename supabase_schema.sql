...
update public.machines
set name = coalesce(name, label, 'Machine ' || machine_number::text)
where name is null;
update public.machines
set enabled = false
...
insert into public.machines (machine_number, label, name, status, load_type, enabled)
select * from (values
  (1, 'Machine 1', 'Machine 1', 'Available', 'Light',  true),
  (2, 'Machine 2', 'Machine 2', 'Available', 'Medium', true),
  (3, 'Machine 3', 'Machine 3', 'In Use',    'Heavy',  true),
  (4, 'Machine 4', 'Machine 4', 'Available', 'Light',  true),
  (5, 'Machine 5', 'Machine 5', 'Available', 'Medium', true),
  (6, 'Machine 6', 'Machine 6', 'In Use',    'Heavy',  true),
  (7, 'Machine 7', 'Machine 7', 'Available', 'Medium', true),
  (8, 'Machine 8', 'Machine 8', 'Available', 'Light',  true)
) as v(machine_number, label, name, status, load_type, enabled)
